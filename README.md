![waving](https://capsule-render.vercel.app/api?type=waving&height=200&text=Jiyoung%20Github!&fontAlign=50&fontAlignY=40&color=0:4facfe,100:00f2fe&fontSize=50&fontColor=FFFFFF&align=center)
...
Built a custom YouTube-style web application using React.js and the YouTube API.  
<br/>
[View site](https://lee-youtube-project.netlify.app/)

### ✨Movie Site✨
Developed a movie information website using Vue.js and the TMDB API. 
<br/>
[View site](https://lee-movie.netlify.app/)

### ✨Web Site✨
Implemented the same web page using both Vue.js and React.js to compare frameworks.
<br/>
[View site(Vue.js 버전)](https://lee-webpage-vue.netlify.app/) /
[View site(React.js 버전)](https://lee-webpage-react.netlify.app/)
